...
public class LibraryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getData("http://13.125.170.131/library.php");
    ...
    protected void showList(){
        try{
            ...
            ListAdapter adapter = new SimpleAdapter(
                    LibraryActivity.this, menuList, R.layout.list_item, new String[]{TAG_CORNER, TAG_DIVISION, TAG_SALETIME, TAG_MENU}, new int[]{R.id.corner, R.id.division, R.id.saletime, R.id.menu}
            );
