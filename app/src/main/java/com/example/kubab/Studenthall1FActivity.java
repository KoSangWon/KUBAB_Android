...
public class Studenthall1FActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_studenthall_1f);
        list=(ListView)findViewById(R.id.listView);
        menuList = new ArrayList<HashMap<String, String>>();
        getData("http://13.125.170.131/studenthall1f.php");
    ...
    protected void showList(){
        try{
            ...
            ListAdapter adapter = new SimpleAdapter(
                    Studenthall1FActivity.this, menuList, R.layout.list_item, new String[]{TAG_CORNER, TAG_DIVISION, TAG_SALETIME, TAG_MENU}, new int[]{R.id.corner, R.id.division, R.id.saletime, R.id.menu}
            );
