...
public class StudenthallB1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_studenthall_b1);
        list=(ListView)findViewById(R.id.listView);
        menuList = new ArrayList<HashMap<String, String>>();
        getData("http://13.125.170.131/studenthallb1.php");
    ...
    protected void showList(){
        try{
            ...
            ListAdapter adapter = new SimpleAdapter(
                    StudenthallB1Activity.this, menuList, R.layout.list_item, new String[]{TAG_CORNER, TAG_DIVISION, TAG_SALETIME, TAG_MENU}, new int[]{R.id.corner, R.id.division, R.id.saletime, R.id.menu}
            );
